...
namespace prakt2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine($"Количество символов в клубе: {count}");
            //2
            ...
            //if (count % 2 == 0)
            //{
            //    Console.Write($"В {town} четное количество символов");
            //}
            //else
            //{
            //    Console.Write($"В {town} нечетное количество символов");
            //}
            ...
            //    }
            //}
            //Console.Write($"Кол-во букв 'а' или 'A' в строке '{line}' равно: {count}");
                        //7
            ...
            //Console.WriteLine($"В предложение {words} слова.");
            Console.ReadKey();
        }
    }
}
